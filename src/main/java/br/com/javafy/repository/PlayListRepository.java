...
//    @Query("SELECT new br.com.javafy.dto.spotify.musica.MusicaCreateDTO ( " +
//            " l.idMusica ) " +
//            " from listademusicas l" +
//            " where (l.idPlaylist = :idPlaylist)")
//    List<MusicaCreateDTO> getAllIdMusicasPlayList(Integer idPlaylist);
